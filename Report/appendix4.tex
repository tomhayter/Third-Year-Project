...
\begin{table}[h]
    ...
    \end{tabular}
    \captionsetup{justification=centering}
    \caption[Study 2 - Question responses from restaurant owners]{Study 2 - Question responses from restaurant owners. Questions marked ``(1-5)'' were marked on a Likert scale.}
